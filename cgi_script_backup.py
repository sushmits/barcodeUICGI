...
if "ERR" in json_out_string:
	...
	print("""<div class="image">
            ...
            <br>
            <a href="""+json_out_obj['csv']+""" style="float:right; padding-right: 10px;font-size: 20px;"> Barcodes_csv_download</a>
            <br>
            <br>
            <a href = """+json_out_obj['dist']+""" style="float:right; padding-right: 10px;font-size: 20px;" onclick="onclickDistanceMatrix()">Distance Matrix </a>
            <br>
            <br>
            <br>"""+
            json_out_obj['html']+"""
...
print("""<form action="/cgi-bin/cgi_script.py" onsubmit="createJson()" method="GET" >
            <div style="width:30%;">  
